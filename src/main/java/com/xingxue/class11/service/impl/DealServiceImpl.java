...
import com.xingxue.class11.entity.mapper.DealDetailMapper;
...
public class DealServiceImpl implements DealService {
    ...
    @Autowired
    private DealDetailMapper dealDetailDAO;
    ...
    public Deal getBySkuIdForDetailViewOnSite(Long skuId) throws DealException,BaseException{
        try {
            ...
            return dealMapper.selectBySkuIdForShowOnView(skuId);
    ...
    public List<Deal> getDealsForIndex(Long areaId, List<Long> categoryIds) throws BaseException{
        try {
            ...
            return dealMapper.selectOnIndex(areaId,DealConstant.DEAL_PUBLISH_STATUS_PUBLISH,categoryIds);
        } catch (Exception e) {
            logger.error(e.getMessage());
            throw new BaseException(ExceptionContants.INNER_ERROR);
        }
    ...
    public List<Deal> getDealsForCart(List<Long> dealIds) throws BaseException{
        try {
            List<Deal> result = dealMapper.selectForCart(dealIds);
            return result;
        } catch (Exception e) {
            logger.error(e.getMessage());
            throw new BaseException(ExceptionContants.INNER_ERROR);
    ...
    public List<Deal> getByCategoryId(Long categoryId) throws DealException,BaseException{
        try {
            ...
            return dealMapper.selectByCategoryId(categoryId);
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public long countByCategoryId(Long categoryId) throws DealException,BaseException {
        try {
            ...
            return dealMapper.countByCategoryId(categoryId);
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public PagingResult<Deal> getDealList(Search search) throws DealException,BaseException{
        try {
            ...
            List<Deal> data = dealMapper.selectPageDeals(search);
            Long total = dealMapper.countPageDeals(search);
            PagingResult<Deal> pageDeals = 
            		new PagingResult<>(search.getRows(),search.getPage(),total, data);
            return pageDeals;
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
    ...
    public int modifyOosStatusById(Deal deal)throws DealException,BaseException {
        try {
            ...
            return dealMapper.modifyOosStatusById(deal.getId(),deal.getOosStatus(),new Date());
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public Deal getBySkuId(Long skuId) throws DealException,BaseException{
        try {
            ...
            return dealMapper.selectBySkuId(skuId);
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public List<Deal> getBySkuIds(List<Long> skuIds)throws DealException,BaseException {
        try {
            ...
            return dealMapper.selectBySkuIds(skuIds);
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public int reduceInventory(Deal deal, int amount) throws DealException,BaseException{
        try {
            ...
            return dealMapper.updateForPlaceOrder(deal.getId(), deal.getInventoryAmount() - amount, deal.getVendibilityAmount() - amount);
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage());
    ...
    public DealDetail getDetailByDealId(Long dealId) throws DealException,BaseException {
        try {
            ...
            DealDetail byDealId = dealDetailDAO.selectByDealId(dealId);
            return byDealId;
        } catch (DealException e) {
            throw e;
        } catch (Exception e) {
