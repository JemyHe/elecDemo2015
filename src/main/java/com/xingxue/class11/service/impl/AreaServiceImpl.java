...
import com.xingxue.class11.entity.mapper.AreaMapper;
...
public class AreaServiceImpl implements AreaService {
    ...
    @Autowired private AreaMapper mapper;
    ...
    public void save(Area area) {
        this.mapper.insertSelective(area);
    }
    ...
    public void update(Area area) {
        this.mapper.updateByPrimaryKeySelective(area);
    }
    ...
    public List<Area> getAll() {
        List<Area> areas = this.mapper.selectAll();
